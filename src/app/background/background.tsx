...
function defaultProps(props: { size: number; innerRadius: number; outerRadius: number; lineSpread: number; endDistance: number; radius: number; lineStartOffset: number; }) {
